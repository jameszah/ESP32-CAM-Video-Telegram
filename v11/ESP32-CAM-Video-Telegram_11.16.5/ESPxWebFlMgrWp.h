...
function editavi(filename) {
     var baseHost0 = document.location.origin
     console.log(baseHost0);
     let baseHost = baseHost0.replace(":8080", "");
     console.log(baseHost);
     
     const query2 = `${baseHost}:/edit?f=` + filename
     window.open(query2, '_blank').focus();

}
function editjpg(filename) {
     var baseHost0 = document.location.origin
     console.log(baseHost0);
     let baseHost = baseHost0.replace(":8080", "");
     console.log(baseHost);
     
     const query2 = `${baseHost}:/editjpg?f=/` + filename
     window.open(query2, '_blank').focus();
